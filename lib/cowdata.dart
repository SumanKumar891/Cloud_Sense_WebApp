...
class CowData extends StatefulWidget {
  ...
  @override
  _CowDataState createState() => _CowDataState();
}

class _CowDataState extends State<CowData> {
  List<dynamic> _data = [];
  ...
  Future<void> _fetchData() async {
    ...
    final url =
        "https://5yxgquepxl.execute-api.us-east-1.amazonaws.com/PROD/gateway-inference-data-fetch?nodeId=$nodeIdToUse&startTime=$startTime&endTime=$endTime";
        ...
        children: [
          ...
          Container(
            ...
            child: BackdropFilter(
              ...
              child: Container(
                color: Colors.black
                    .withOpacity(0.6), // Optional overlay for readability
              ),
            ),
          ),
